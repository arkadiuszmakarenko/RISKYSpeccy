...
/* IAP binary File */
#define DEF_IAP_FILE_NAME "/RISKYZXS.UPD"
...
extern uint32_t _flash_limit;      /* Symbol from linker script defining flash end */
#define FLASH_BASE_ADDR 0x08000000
#define DEF_APP_CODE_START_ADDR (FLASH_BASE_ADDR + 0x00004000UL)

#define DEF_APP_CODE_END_ADDR (FLASH_BASE_ADDR + (uint32_t)&_flash_limit)     /* IAP Flash operation end address (exclusive) */
